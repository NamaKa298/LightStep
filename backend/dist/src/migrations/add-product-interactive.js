...
async function addProductInteractive() {
    try {
        ...
        const type = typeMap[typeChoice] || "Autre";
        console.log("\n📂 Catégorie :");
        console.log("   1. trail");
        ...
        const category = categoryMap[categoryChoice] || "casual";
        console.log("\n👫 Genre :");
        ...
        const gender = genderMap[genderChoice] || "U";
        // Champs optionnels
        console.log("\n📝 Description (optionnel) :");
        const description = await askQuestion("   Description : ");
        // Stock par taille
        console.log("\n📦 Stock par taille :");
        console.log("   Entrez le stock pour chaque taille (appuyez sur Entrée pour 0)");
        const stock = [];
